...
_Created: 11-10-2025 · Last updated: 11-07-2026_
...
Требуется Node.js 20+ (`package.json` → `engines.node: ">=20.0"`, требование Docusaurus 3.9).
Зависимости зафиксированы в `package-lock.json`, поэтому команды — через npm:
...
электронного издания). До ее принятия репозиторий распространяется без явной лицензии;
